...
public class MainActivity1 extends AppCompatActivity {
    ...
    @Override    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonStart.setOnClickListener(v -> { if (!frameAnimation.isRunning()) { frameAnimation.start(); } });
        buttonStop.setOnClickListener(v -> { if (frameAnimation.isRunning()) { frameAnimation.stop(); } });
    }}